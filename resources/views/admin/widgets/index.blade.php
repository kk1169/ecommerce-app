                ...
                <div class="card app-card">
                    <div class="card-body">
                        ...
                        <div class="d-flex g-4">
                            <button class="btn btn-icon btn-danger confirm_button"><i
                                    class="las la-trash-alt la-2x"></i></button>
                            ...
                            <button class="btn btn-icon btn-success confirm_toast">Toast</button>
                        </div>
