<div class="be-header">
    <div class="btn btn-light be-header-icon" id="beSidebarNavOpen">
    ...
    <div class="be-header-options">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="#"><i class="ri-user-line"></i>My Account</a></li>
                ...
                <li><a class="dropdown-item" href="#"><i class="ri-shut-down-line"></i>Logout</a></li>
            </ul>
        </div>
    </div>
</div>
